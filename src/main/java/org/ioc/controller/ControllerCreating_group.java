...
import org.ioc.DataBase.DB_CreateGroupe;
...
public class ControllerCreating_group {
    ...
    void initialize() {
        ...
        DegreeID.setOnAction(ActionEvent ->{
            ...
            DB_CreateGroupe ID_OF_SPEC = new DB_CreateGroupe();
            ...
            DB_CreateGroupe ShortName = new DB_CreateGroupe();
        ...
        Name_of_Group.setOnAction(actionEvent -> {
            ...
            DB_CreateGroupe nameAndIdOfGroup = new DB_CreateGroupe();
        ...
        Create_button.setOnAction(actionEvent -> {
            ...
            if (GroupName_bool && NumberOfCourse_bool && NumberOfGroup_bool && YearOfGroup_bool){
                ...
                DB_CreateGroupe CreateGroup = new DB_CreateGroupe();
